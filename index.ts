...
// Type Inference
let myName = "Mantu kumar"
// The compiler inferes the type string for the variable myName
let numberValue = 5;
// The compiler also infers the type number for the variable numberValue
console.log("My name is : " , myName);
console.log("Number is : " , numberValue);

// Write the difintion of the type inference
